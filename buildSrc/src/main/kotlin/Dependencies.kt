...
object Hilt {
    ...
    val hiltWorker by lazy { "androidx.hilt:hilt-work:${Versions.hiltAndroidXCompiler}" }
...
object DotsIndicator {
    val indicator by lazy { "com.tbuonomo.andrui:viewpagerdotsindicator:4.1.2" }
}

object MpAndroidChart {
    val mPCHart by lazy { "com.github.PhilJay:MPAndroidChart:v3.1.0" }
}

object LoopeerShadow {
    val loopeer by lazy { "com.loopeer.lib:shadow:0.0.4-beta3" }
}

object Map{
    val maps by lazy { "com.google.android.gms:play-services-maps:17.0.0" }
}
...
object WorkManager{
    val runtime by lazy { "androidx.work:work-runtime-ktx:2.7.1" }
    val multiprocess by lazy { "androidx.work:work-multiprocess:2.7.1" }
}
